...
### О нейминге, регламенте и скинах
...
В примере я использовал 4 IK кости, две для стоп, две для кистей. Обычно, можно оставлять только стопы.
